...
object RetrofitClient {
    ...
    // For physical device: http://172.20.10.4:3000/ o http://127.0.0.1:3000
    ...
    fun getFriendApiService(): FriendApiService {
        return getRetrofitInstance().create(FriendApiService::class.java)
    }
}